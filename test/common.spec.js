...
import {
  getDownloadFilename, getCalendarTitle, getEventCategories,
  shouldRenderBrief} from '../src/common';
import {Event, flags} from '@hebcal/core/dist/esm/event';
import {HebrewCalendar, Location, HDate, HolidayEvent,
...
test('getEventCategories', () => {
  ...
  const expected = {
    ...
    'Chanukah: 1 Candle': ['holiday', 'minor'],
    'Chanukah: 2 Candles': ['holiday', 'minor'],
    'Chanukah: 3 Candles': ['holiday', 'minor'],
    'Chanukah: 4 Candles': ['holiday', 'minor'],
    'Chanukah: 5 Candles': ['holiday', 'minor'],
    'Chanukah: 6 Candles': ['holiday', 'minor'],
    'Chanukah: 7 Candles': ['holiday', 'minor'],
    'Rosh Chodesh Tevet': ['roshchodesh'],
    'Chanukah: 8 Candles': ['holiday', 'minor'],
